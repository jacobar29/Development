...
#include "SynthSound.h"
 ...
 public:
	 ...
	 double getosc2Note()
	 {
		 ...
		 switch (osc2WaveType)
		 {
		 case 0: return env2.adsr(osc2.sinewave(freq2)* gain, env2.trigger);
			 break;

		 case 1: return env2.adsr(osc2.sawWave(freq2)* gain2, env2.trigger);
			 break;
		 case 2: return env2.adsr(osc2.squareWave(freq2)* gain2, env2.trigger);
			 break;
		 case 3: return env2.adsr(osc2.triangleWave(freq2)* gain2, env2.trigger);
			 break;
		 case 4: return env2.adsr(osc2.whiteNoise()*  gain2, env2.trigger);
			 break;
	 ...
	 double getFilteredNote()
	 {
		 ...
		 {
		 case 0: wave1 = filter1.lowPass(getosc1Note(), osc1cutoff, filter1Resonance);
			 break;
		 case 1: wave1 = filter1.highPass(getosc1Note(), osc1cutoff, filter1Resonance);
			 break;
		 default: wave1 = filter1.lowPass(getosc1Note(), osc1cutoff, filter1Resonance);
			 break;
		 }
	
		 switch (osc2FilterChoice)
		 {
		 case 0: wave2 = filter2.lowPass(getosc2Note(), osc2cutoff, filter2Resonance);
			 break;
		 case 1: wave2 = filter2.highPass(getosc2Note(), osc2cutoff, filter2Resonance);
			 break;
		 default: wave2 = filter2.highPass(getosc2Note(), osc2cutoff, filter2Resonance);
			 break;
